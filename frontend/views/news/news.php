                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="/uploads/news/<?php echo $news->image?>">
                                        <img class="d-block w-100" src="/uploads/news/<?php echo $news->image?>" alt="First slide">
                                    </a>
                                </div>
                            </div>
                        </div>
