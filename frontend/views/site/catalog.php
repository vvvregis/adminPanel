                    ...
                    <ul>
                        <?php if($categoryList):?>
                            <?php foreach ($categoryList as $itemInfo):?>
                                <li><a href="/site/subcategory?alias=<?php echo $itemInfo->alias?>"><?php echo $itemInfo->name?></a></li>
                            <?php endforeach;?>
                        <?php endif;?>
                    </ul>
                </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img class="old-hover" src="/uploads/catalog/<?php echo $itemInfo->image?>" alt="">
                                    </div>
                                    ...
                                    <div class="product-description d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="product-meta-data">
                                            <div class="line"></div>
                                            <a href="/site/subcategory?alias=<?php echo $itemInfo->alias?>">
