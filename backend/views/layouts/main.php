                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            [
                                "items" => [
                                    ...
                                    ["label" => "Информационные страницы", "url" => "/admin/page", "icon" => "home"],
                                    ["label" => "Статьи", "url" => "/admin/article", "icon" => "home"],
                                    ["label" => "Категории статей", "url" => "/admin/article-categories", "icon" => "home"],
